 ...
 * get you started.
 * 
 * @author mvail, mhthomas, amussell (lambdas), briglowell
 */
public class ListTester {
	...
	private void runTests() {
		...
		testSingleElementList(emptyList_add0A_A, "emptyList_add(0,A)", LIST_A, STRING_A);
		testSingleElementList(emptyList_listIteratorAddA_A, "emptyList_listIteratorAddA_A", LIST_A, STRING_A);
		//1-element to empty list
		testEmptyList(A_removeFirstA_emptyList, "A_removeFirstA_emptyList");
		testEmptyList(A_removeLastA_emptyList, "A_removeLastA_emptyList");
		testEmptyList(A_removeA_emptyList, "A_removeA_emptyList");
		testEmptyList(A_remove0A_emptyList, "A_remove0A_emptyList");
		...
		testSingleElementList(AB_removeFirstA_B, "AB_removeFirstA_B", LIST_B, STRING_B);
		testSingleElementList(AB_removeLastB_A, "AB_removeLastB_A", LIST_A, STRING_A);
		...
		testTwoElementList(AB_ListIterSet1C_AC, "AB_ListIterSet1C_AC", LIST_AC, STRING_AC);
		//3-element to 2-element
		testTwoElementList(ABC_IterRemoveA_BC, "ABC_IterRemoveA_BC", LIST_BC, STRING_BC);
		testTwoElementList(ABC_removeLastC_AB, "ABC_removeLast_AB", LIST_AB, STRING_AB);
...
//			break;
	...
	/**Scenario: empty list -> listIteratorAdd(A) -> [A]
	 * @return [A] after listIteratorAdd(A)
	 */
	...
	//single element to emptyList
	/** Scenario: [A] -> removeFirst(A) -> [] 
	 * @return [] after removeFirst(A)
	 */
	private IndexedUnsortedList<Integer> A_removeFirstA_emptyList() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A();
		list.removeFirst();
		return list;
	}
	private Scenario<Integer> A_removeFirstA_emptyList = () -> A_removeFirstA_emptyList();
	
	/** Scenario: [A] -> removeLast(A) -> [] 
	 * @return [] after removeLast(A)
	 */
	private IndexedUnsortedList<Integer> A_removeLastA_emptyList() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A();
		list.removeLast();
		return list;
	}
	private Scenario<Integer> A_removeLastA_emptyList = () -> A_removeLastA_emptyList();
	 ...
	 */
	private IndexedUnsortedList<Integer> A_remove0A_emptyList() {
		IndexedUnsortedList<Integer> list = emptyList_addToFrontA_A();
		list.remove(0);
		return list;
	}
	private Scenario<Integer> A_remove0A_emptyList = () -> A_remove0A_emptyList();
	
	/** Scenario: [A] -> IterRemove(A) -> [] 
	 * @return [] after ItarRemove(A)
	 */
	...
	//single element to changed single element
	...
	//two element to single element
	/**Scenario: [A,B] -> removeFirst(A) -> [B]
	 * @return [B] after removeFirst(A)
	 */
	private IndexedUnsortedList<Integer> AB_removeFirstA_B(){
		IndexedUnsortedList<Integer> list = A_addToRearB_AB();
		list.removeFirst();
		return list;
	}
	private Scenario<Integer> AB_removeFirstA_B = () -> AB_removeFirstA_B();
	
	/**Scenario: [A,B] -> removeLast(B) -> [A]
	 * @return [A] after removeLast(B)
	 */
	private IndexedUnsortedList<Integer> AB_removeLastB_A(){
		IndexedUnsortedList<Integer> list = A_addToRearB_AB();
		list.removeLast();
		return list;
	}
	private Scenario<Integer> AB_removeLastB_A = () -> AB_removeLastB_A();
	...
	/**Scenario: [A,B] -> ListIterRemove(B) -> [A]
	 * @return [A] after ListIterRemove(B)
	 */
	...
	/**Scenario: [A,B,C] -> removeLast(C) -> [A,B]
	 * @return [A,B] after removeLast(C)
	 */
	private IndexedUnsortedList<Integer> ABC_removeLastC_AB(){
		IndexedUnsortedList<Integer> list = AB_addToRearC_ABC();
		list.removeLast();
		return list;
	}
	private Scenario<Integer> ABC_removeLastC_AB = () -> ABC_removeLastC_AB();
	
	/**Scenario: [A,B,C] -> remove0(0) -> [B,C]
	...
	//two element to changed two element
	...
	/** Scenario: [A,B] -> ListIterSet(1,C) -> [A,C] 
	 * @return [A,C] after ListIterSet(1,C)
	 */
	private IndexedUnsortedList<Integer> AB_ListIterSet1C_AC() {
		IndexedUnsortedList<Integer> list = A_addToRearB_AB(); 
		ListIterator<Integer> lit = list.listIterator();
		lit.next();
		lit.next();
	...
	private Scenario<Integer> AB_ListIterSet1C_AC = () -> AB_ListIterSet1C_AC();
	
	//three element to changed 3 element
	...
	private void testTwoElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents, String contentsString) {
		...
		try {
			...
			printTest(scenarioName + "_testIter", testIter(scenario.build(), Result.NoException));
			printTest(scenarioName + "_testIterHasNext", testIterHasNext(scenario.build().iterator(), Result.True));
			printTest(scenarioName + "_testIterNext0", testIterNext(scenario.build().iterator(), contents[0], Result.MatchingValue));
			printTest(scenarioName + "_testIterRemove", testIterRemove(scenario.build().iterator(), Result.IllegalState));
			...
			if (SUPPORTS_LIST_ITERATOR) {
				...
				printTest(scenarioName + "_testListIterNextAdd", testListIterAdd(listIterAfterNext(scenario.build().listIterator(), 1), ELEMENT_X, Result.NoException));			
				printTest(scenarioName + "_testListIterNextSet", testListIterSet(listIterAfterNext(scenario.build().listIterator(), 1), ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIterNextNextRemove", testIterRemove(listIterAfterNext(scenario.build().listIterator(), 2), Result.NoException));
				printTest(scenarioName + "_testListIterNextNextAdd", testListIterAdd(listIterAfterNext(scenario.build().listIterator(), 2), ELEMENT_X, Result.NoException));			
				printTest(scenarioName + "_testListIterNextNextSet", testListIterSet(listIterAfterNext(scenario.build().listIterator(), 2), ELEMENT_X, Result.NoException));
				printTest(scenarioName + "_testListIterNextRemoveRemove", testIterRemove(listIterAfterRemove(listIterAfterNext(scenario.build().listIterator(), 1)), Result.IllegalState));
				printTest(scenarioName + "_testListIterNextPreviousRemove", testIterRemove(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 1), 1), Result.NoException));
				printTest(scenarioName + "_testListIterNextPreviousRemoveRemove", testIterRemove(listIterAfterRemove(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 1), 1)), Result.IllegalState));
				printTest(scenarioName + "_testListIterNextPreviousAdd", testListIterAdd(listIterAfterPrevious(listIterAfterNext(scenario.build().listIterator(), 1), 1), ELEMENT_X, Result.NoException));			
...
//	private Iterator<Integer> iterRemoveAfterNext(IndexedUnsortedList<Integer> list, int numCallsToNext){
//		Iterator<Integer> it = list.iterator();
//		for (int i = 0; i < numCallsToNext; i++) {
//			it.next();
//			it.remove();
